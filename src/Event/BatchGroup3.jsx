...
import img25 from "../assets/9.jpg";
import img26 from "../assets/27.jpg";
import img27 from "../assets/28.jpg";
import img28 from "../assets/31.jpg";
import img29 from "../assets/32.jpg";

function BatchGroup3() {
  return (
    <div className="BatchGroup3">
      <div className="title">
        ...
        <table>
          <tr>
            <td>
              ...
              <img src={img27} className="w-100 m-1 p-1" alt="" />
            </td>
            <td>
              ...
              <img src={img28} className="w-100 m-1 p-1" alt="" />
            </td>
          </tr>
        </table>
      </div>
